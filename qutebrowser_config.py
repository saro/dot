...
config.bind('b', None)
config.bind('bc', 'spawn gvim .config/qutebrowser/config.py')
...
config.bind('bs', 'set --pattern *://{url:host}/* content.ssl_strict false ;; reload ;; message-info "ACCEPT SSL CERT"')
config.bind('bS', 'set --pattern *://{url:host}/* content.ssl_strict true ;; reload ;; message-info "FORGET SSL CERT"')
config.bind('f', 'hint')
